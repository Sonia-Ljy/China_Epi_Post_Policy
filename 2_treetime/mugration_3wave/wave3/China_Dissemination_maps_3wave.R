...
setwd("/home/soniali/Desktop/02_china_recom_github/2_treetime/mugration_3wave/")
worldmap <- getMap()
...
alpha_absolutes
setwd(paste0("/home/soniali/Desktop/02_china_recom_github/2_treetime/mugration_3wave/wave",wave_number))
...
write.table(d_alpha_links,file = "d_alpha_links_wave3.csv",append = FALSE,sep = ",")
